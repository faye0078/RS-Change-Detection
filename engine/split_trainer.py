...
class Trainer(object):
    def __init__(self, args):
        ...
        self.train_set, self.val_set, self.train_loader, self.val_loader = make_dataloader(self.origin_config['dataset'], False)
    ...
    def train(self, iters=None):
        ...
        while iter < iters:
            for data in self.train_loader:
                ...
                if nranks > 1:
                    logits_list = ddp_model(image1, image2)
                else:
                    logits_list = self.model(image1, image2)
